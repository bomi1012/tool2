...
//					recipe = (Recipe) event.getProperty().getValue();
//				}
//
//			}
//		});
...
//		BeanItemContainer<Recipe> container;
//
//		try {
//			//Container mit den Spalten Name, Rezeptart, Mitarbeiter, Erstellt.
//			container = new BeanItemContainer<Recipe>(Recipe.class,
...
//						&& table.getValue() instanceof Recipe) {
//
//					Recipe rezeptAusTb = (Recipe) table.getValue();
//					ViewHandler.getInstance().switchView(RezeptAnlegen.class,
//							new ViewDataObject<Recipe>(rezeptAusTb));
//				} else {
