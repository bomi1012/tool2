...
//						((Application) UI.getCurrent().getData()).getUser().getId() == recipe.getEmployee().getId()){					
//					try {
//						Rezeptverwaltung.getInstance().deaktiviereRezept(recipe.getId(), true);
//						
//						((Application) UI.getCurrent().getData())
//						.showDialog("Rezept '" + recipe.getName() + "'  wurde gelöscht");
//						
//						ViewHandler.getInstance().switchView(
//								RezeptAnzeigenTabelle.class,
//								new ViewDataObject<Recipe>(recipe));
//						
//					} catch (Exception e) {
//						e.printStackTrace();
//					} 				
...
//				else{
//					((Application) UI.getCurrent().getData())
//					.showDialog("Rezept '" + recipe.getName() + "' kann nur " + recipe.getEmployee().getVorname() + " oder Administrator deaktivieren");
//				}
//				
//			}
//		});
...
//			}
//			List<Recipetype> recipetype = Rezeptartverwaltung.getInstance()
//					.getAllRezeptart();
//			for (Recipetype ra : recipetype) {
...
//		recipe = (Recipe) ((ViewDataObject<?>) data).getData();
//
//		try {
//			recipe = Rezeptverwaltung.getInstance().getRezeptById(
//					recipe.getId());
...
//		}
//		if (recipe.getRezeptHasArtikelList() != null) {
//			tmpZutaten = recipe.getRezeptHasArtikelList();
//		} else {
//			tmpZutaten = new ArrayList<RezeptHasArtikel>();
//		}
//		mitarbeiterNs.select(recipe.getEmployee());
//		rezeptartNs.select(recipe.getRezeptart());
...
//		 */
//		try {
//			name.setValue(RezeptDAO.getInstance().getRezeptById(recipe.getId())
//					.getName().toString());
//		} catch (Exception e3) {
//			e3.printStackTrace();
//		}
//
//		for (int i = 0; i < recipe.getZubereitung().size(); i++) {
//			zubereitung.select(recipe.getZubereitung().get(i));
//		}
//
...
//					RezeptHasArtikel.class, recipe.getRezeptHasArtikelList());
//
//			zutatenTable = null;
//			zutatenTable = new Table();
//			zutatenTable.setSizeFull();
...
//
//		}
//		recipe.setRezeptHasArtikelList(list);
//
//		try {
//			kommentar.setValue(RezeptDAO.getInstance()
//					.getRezeptById(recipe.getId()).getKommentar().toString());
...
//
//		rez.setRezeptart((Recipetype) rezeptartNs.getValue());
//
//		try {
//			rez.setEmployee((Employee) mitarbeiterNs.getValue());
//
//		} catch (Exception e1) {
//			e1.printStackTrace();
//		}
...
//			rezeptNeu.setRezeptHasArtikelList(ausgArtikel);
//
//			try {
...
//		java.util.Date date = new java.util.Date();
//		Date date2 = new Date(date.getTime());
//		recipe.setErstellt(date2);
//
//		// setzt Kommentar
//		recipe.setKommentar(kommentarInput);
//
//		// setzt Rezeptart
//		try {
//			recipe.setRezeptart((Recipetype) rezeptartNs.getValue());
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//
//		// setzt Mitarbeiter
//		try {
//			recipe.setEmployee((Employee) mitarbeiterNs.getValue());
//		} catch (Exception e1) {
//			e1.printStackTrace();
//		}
//
//		// Setze Artikel
//		recipe.setRezeptHasArtikelList(tmpZutaten);
//
//		try {
//			Rezeptverwaltung.getInstance().updateRezept(recipe);
//			Rezeptverwaltung.getInstance().deleteZutatenZuRezept(recipe);
//			Rezeptverwaltung.getInstance().saveArtikel(recipe);
//			Rezeptverwaltung.getInstance().deleteZubereitungZuRezept(recipe);
