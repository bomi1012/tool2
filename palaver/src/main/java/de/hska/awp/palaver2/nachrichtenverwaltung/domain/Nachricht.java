...
public class Nachricht implements java.io.Serializable {
	...
	private Long id;
	private Employee mitarbeiterBySenderFk;
	...
	public Nachricht(Employee mitarbeiterBySenderFk, Rollen empfaengerRolle) {
		this.mitarbeiterBySenderFk = mitarbeiterBySenderFk;
		this.empfaengerRolle = empfaengerRolle;
	}

	public Nachricht(Long id, String nachricht, Employee mitarbeiterBySenderFk, Rollen empfaengerRolle) {
		this.id = id;
	...
	public Nachricht(Long id, String nachricht, Employee mitarbeiterBySenderFk) {
		this.id = id;
		this.nachricht = nachricht;
		this.mitarbeiterBySenderFk = mitarbeiterBySenderFk;
	...
	public Employee getMitarbeiterBySenderFk() {
		return this.mitarbeiterBySenderFk;
	}

	public void setMitarbeiterBySenderFk(Employee mitarbeiterBySenderFk) {
		this.mitarbeiterBySenderFk = mitarbeiterBySenderFk;
	}
